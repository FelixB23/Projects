Ce projet a été réalisé par Félix Baubriaud et Merwan Benbadra en janvier 2022 lors de la 1ère année du cycle ingénieur "Ingénierie et Data Science" à Polytech Clermont. C'est un site sur le programme de mathématiques de terminale S.
...
Nous nous sommes répartis les tâches de la façon suivante : l'un s'occupait des chapitres impairs + page du bac (Félix), l'autre des chapitres pairs + page d'accueil (Merwan).
...
sauf pour les images que nous avons créées manuellement (l'arbre de probabilité et le cercle trigonométrique) qui sont dans le dossier.
